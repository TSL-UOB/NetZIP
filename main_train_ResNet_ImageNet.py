...
def prepare_dataloader(num_workers=8, train_batch_size=128, eval_batch_size=256):
    ...
    if len(os.listdir(path))==0:
        ...
        print("Downloaded Imagnet zip file.")
    
    if len(os.listdir(path))<2:
        with ZipFile(path+"ILSVRC2017_DET", "r") as file:
            file.extractall(path)
        print("Extracted Imagnet files.")
    else:
    ...
    train_set = torchvision.datasets.ImageNet(root="./datasets/ImageNet", train=True, transform=train_transform) 
    # We will use test set for validation and test in this project.
    # Do not use test set for validation in practice!
    test_set = torchvision.datasets.ImageNet(root="./datasets/ImageNet", train=False, transform=test_transform)
...
def main():
    ...
    model_dir = "models/trained_models/ImageNet"
