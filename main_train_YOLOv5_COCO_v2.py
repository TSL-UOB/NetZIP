...
if not Path("./models/yolov5/").exists():
...
# ROOT = FILE.parents[0]/"models/yolov5"  # YOLOv5 root directory
# print("ROOt = ",ROOT)
...
#     if os.path.exists(path+'train2017'):
...
#     if os.path.exists(path+'val2017'):
...
#     parser.add_argument('--cfg', type=str, default='models/yolov5/models/yolov5s_netzip.yaml', help='model.yaml path')
#     # parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')
#     # parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-low.yaml', help='hyperparameters path')
#     parser.add_argument('--data', type=str, default='models/yolov5/data/COCO.yaml', help='dataset.yaml path')
#     parser.add_argument('--hyp', type=str, default='models/yolov5/data/hyps/hyp.scratch-custom.yaml', help='hyperparameters path')
...
#     path = "./datasets/COCO/"
#     if not os.path.exists(path+'images') or not os.path.exists(path+'labels'):
