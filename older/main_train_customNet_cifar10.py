...
# Let us see what the neural network thinks these examples above
outputs = net(images)
...
# input("Let us look at how the network performs on the whole dataset.")
correct = 0
total = 0
...
# input("What are the classes that performed well, and the classes that did not perform well?")
