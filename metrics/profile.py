# Code modified from: https://github.com/e-lab/pytorch-toolbox/tree/master/profiler
...
def profile(model, input_size, count_quantised_operations = True):#custom_ops = {}):
    ...
    def add_hooks(m):
        ...
        if isinstance(m, nn.Conv2d):
            ...
            pass
        elif isinstance(m, nnq.Conv2d) and count_quantised_operations:
            m.register_forward_hook(count_conv2d)
        elif isinstance(m, nnq.BatchNorm2d) and count_quantised_operations:
            m.register_forward_hook(count_bn2d)
        elif isinstance(m, nnq.Linear) and count_quantised_operations:
            m.register_forward_hook(count_linear)
        
        else:
            # Uncomment below to see which modueles are nor implemented
